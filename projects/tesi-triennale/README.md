# tesi-triennale — control & estimation excerpts
...
**Stack:** Python 3, NumPy, SciPy (`scipy.linalg.expm`, `scipy.stats.chi2`). No framework dependencies in these excerpts — pure numerical code.
...
- the hybrid RL ↔ MPC arbitration / switching logic and its safety-index formulation;
